          ...
          <div className="mt-10 flex flex-col items-center space-y-4">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="inline-flex items-center glass px-6 py-2 rounded-full text-white hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 border border-white/10 text-sm"
              >
              ...
              <a 
                ...
                className="inline-flex items-center btn-gradient px-6 py-2 rounded-full text-white hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-pink-500/30 text-sm"
              >
